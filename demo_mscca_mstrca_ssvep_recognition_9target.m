...
% TW = 1.5;
TW_p = round(TW*Fs);
% enable_bit=[1 1 0 0 0];             % Select the algorithms: bit 1: eCCA, bit 2: ms-eCCA, bit 3: eTRCA, bit 4: ms-eTRCA, bit 5: TDCA, e.g., enable_bit=[1 1 1 1 1]; -> select all four algorithms
